window.snake.more_menu = function(e) {
  ...
  // micro
  let img = new Image;
  img.src = 'https://cdn.discordapp.com/attachments/884568457566371888/912947967860830208/georgy.png';
  img.width = 47;
  img.height = 47;
        ...
        fishes.replace(
          ...
          `(a)
            ...
            if(${words} === 6) {
              ...
              [...__b.children].forEach((e, i) => i > 1 && (__b.removeChild(__b.children[i])));
              __c = new Image;
              __c.src = 'https://cdn.discordapp.com/attachments/884568457566371888/912947967860830208/georgy.png';
              __c.width = __c.height = 47;
              __c.style = 'position:fixed;top: 10px;';
              __b.appendChild(__c);
            }
